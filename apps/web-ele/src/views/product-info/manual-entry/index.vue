...
<template>
  <Page description="无 Excel 时快速录入一个商品，并可同步录入报价阶梯" title="手动单品快速建档">
    <ElAlert class="mb-4" :closable="false" show-icon title="手动建档复用产品、系列、报价和阶梯价 API；入库后可继续前往资料补齐工作台上传图片、规格书和技术资料。" type="info" />
