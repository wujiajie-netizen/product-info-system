...
import type { FrontQaSortBy, QaCategoryTab, QaSortOption } from '#/hooks/useQaCenter';

defineProps<{
  selectedCategory: 'all' | QaQuestionCategory;
...
const emit = defineEmits<{
  'open-ask': [];
  'select-category': [category: 'all' | QaQuestionCategory];
